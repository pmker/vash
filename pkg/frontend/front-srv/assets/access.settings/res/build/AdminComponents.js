        ...
        var GET_SOME_HELP_CARD = React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(FlatButton, { label: message('kb.btn.alldocs'), primary: true, onTouchTap: function () {
                        window.open('https://github.com/pmker/leven/wiki');
                    } }),
        ...
        var PAY_IT_FORWARD_CARD = React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Divider, null),
                    React.createElement(ListItem, { disabled: true, primaryText: message('cont.topic.report.2'), rightIconButton: this.getOpenIcon('https://github.com/pmker/leven') }),
                    React.createElement(Divider, null),
                    React.createElement(ListItem, { disabled: true, primaryText: message('cont.topic.pr'), rightIconButton: this.getOpenIcon('https://github.com/pmker/leven') }),
                    React.createElement(Divider, null),
            ...
            React.createElement(
                ...
                React.createElement(FlatButton, { label: message('cont.btn.github'), primary: true, icon: React.createElement(FontIcon, { className: 'mdi mdi-github-box' }), onTouchTap: function () {
                        window.open('https://github.com/pmker/leven');
                    } }),
