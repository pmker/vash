        ...
        const GET_SOME_HELP_CARD = (
            <Card style={paperStyle} containerStyle={flexContainerStyle}>
                ...
                <CardActions style={{textAlign:'right'}}>
                    <FlatButton label={message('kb.btn.alldocs')} primary={true} onTouchTap={()=>{window.open('https://github.com/pmker/leven/wiki')}}/>
            ...
            <Card style={paperStyle} containerStyle={flexContainerStyle}>
                ...
                <CardText style={flexFill}>
                    ...
                    <List>
                        ...
                        <Divider/>
                        <ListItem disabled={true} primaryText={message('cont.topic.report.2')} rightIconButton={this.getOpenIcon('https://github.com/pmker/leven')}/>
                        <Divider/>
                        <ListItem disabled={true} primaryText={message('cont.topic.pr')} rightIconButton={this.getOpenIcon('https://github.com/pmker/leven')}/>
                        <Divider/>
                ...
                <CardActions style={{textAlign:'center'}}>
                    <FlatButton label={message('cont.btn.github')} primary={true} icon={<FontIcon className="mdi mdi-github-box" />} onTouchTap={()=>{window.open('https://github.com/pmker/leven')}} />
