...
import (
	...
	"github.com/pmker/leven/discovery/nats"

	"github.com/pmker/vash/pkg/common/registry"

	// All brokers
	httpbroker "github.com/pmker/vash/pkg/common/micro/broker/http"
	natsbroker "github.com/pmker/vash/pkg/common/micro/broker/nats"

	// All registries
	consulregistry "github.com/pmker/vash/pkg/common/micro/registry/consul"
	natsregistry "github.com/pmker/vash/pkg/common/micro/registry/nats"

	// All transports
	grpctransport "github.com/pmker/vash/pkg/common/micro/transport/grpc"
)
