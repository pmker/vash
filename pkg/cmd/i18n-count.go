...
import (
	...
	i18n2 "github.com/pmker/vash/pkg/common/utils/i18n"
)
...
$` + os.Args[0] + ` i18n count -p $GOPATH/src/github.com/pmker/leven-enterprise -p $GOPATH/src/github.com/pmker/leven
`,
